...
const Product = () => {
  ...
  return (
    <div>
      <div className="mx-[60px] my-11 flex flex-col gap-20 pb-10 lg:flex-row">
        <div className="hidden flex-col gap-y-7 lg:flex">
          <div className="cursor-pointer overflow-hidden rounded-md border-2 hover:border-[#282828]">
            <img src={item.src} className="w-[150px]" alt="" />
          </div>
          <div className="cursor-pointer rounded-md border-2 hover:border-[#282828]">
            <img src={item.src} className="w-[150px]" alt="" />
          </div>
          <div className="cursor-pointer rounded-md border-2 hover:border-[#282828]">
            <img src={item.src} className="w-[150px]" alt="" />
        ...
        <div className="mx-auto w-[90%] lg:w-[50%]">
          ...
          <div className="my-6 flex">
            <span className="rounded-full border-2 bg-black p-5 hover:border-[#282828]"></span>
            <span className="rounded-full border-2 bg-white p-5 hover:border-[#282828]"></span>
            <span className="rounded-full border-2 bg-blue-600 p-5 hover:border-[#282828]"></span>
          </div>
